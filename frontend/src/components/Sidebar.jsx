    ...
    return (
        ...
        >
                        ...
                        <>
                            {user.role === 'customer' ? (
                                ...
                                <>
                                    ...
                                    <DrawerLink to="/dashboard" text="Dashboard" icon={<GridIcon />} onClick={() => setIsOpen(false)} />
                                    ...
                                    {user.role === "admin" && (
                                        <DrawerLink to="/admin" text="Order Status" icon={<ClipboardIcon />} onClick={() => setIsOpen(false)} />
                                    )}
            ...
            <div className="p-6 border-t border-white/5 bg-night/10">
                <a
                    href="mailto:sowndharsv2006@gmail.com"
